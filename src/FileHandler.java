...
public class FileHandler {
    // Reads a matrix of features and a vector of class labels and outputs a Vector ArrayList.
    public static ArrayList<Vector> read(String matrixPath, String labelPath){
        ...
        try {
            ...
            // Stores the feature values in the Vector object at each index. 
            while ((text = reader.readLine()) != null) {
                ...
                if (obsArr[obsNo] == null) {
                    // Creates a Vector at that index if there is not one already.
                    obsArr[obsNo] = new Vector();
                    // Inserts the key-value pair into the relevant Vector object.
        ...
        try {
            ...
            while ((text = reader.readLine()) != null) {
                // Sets the class label of the Vector corresponding to the number on that line.
                String[] split = text.split(",");
        ...
        ArrayList<Vector> obsList = new ArrayList<Vector>(Arrays.asList(obsArr));
