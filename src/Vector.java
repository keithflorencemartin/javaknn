...
public class Vector {
    ...
    public void putFeature(int feature, int value){ features.put(feature, value); } 
    public void setClassLabel(String classLabel) { this.classLabel = classLabel; }
    public String getClassLabel() { return classLabel; }
    public Integer getFeature(int feature) { return features.get(feature); }
    public Set<Integer> getFeatures() { return features.keySet(); } // Iterator over features.
}
