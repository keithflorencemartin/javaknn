...
public class kNearestNeighbours {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("LEAVE-ONE-OUT CROSS VALIDATION FOR UNWEIGHTED KNN\n***********************************\nK\t\tAccuracy");
        // For each k.
        for (int K = 1; K <= 10; K++){
            int correct = 0;
            int incorrect = 0;
    ...
    public static Observation classify(Observation test, ArrayList<Observation> train, int K, String distanceMeasure, boolean weighted){
        ...
        for (int i = 0; i < neighbours.length; i++){
            ...
            else throw new IllegalArgumentException("Invalid argument for distance measure: " + distanceMeasure);
        }
